...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to qynod "gobject list" output
    ...
    def qynod_serialise(self):
        import qynolib
        return qynolib.SHIM_serialise_for_qynod(self.serialise())
