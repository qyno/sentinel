...
sentinel_cfg = QynoConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_qynod_proto_version_with_sentinel_ping = 70207


def get_qyno_conf():
    home = os.environ.get('HOME')

    qyno_conf = os.path.join(home, ".qyno/qyno.conf")
    if sys.platform == 'darwin':
        qyno_conf = os.path.join(home, "Library/Application Support/Qyno/qyno.conf")

    qyno_conf = sentinel_cfg.get('qyno_conf', qyno_conf)
